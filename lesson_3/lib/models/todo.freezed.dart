...
mixin _$Todo {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, objectId, text, isDone);

  @override
  String toString() {
    return 'Todo(objectId: $objectId, text: $text, isDone: $isDone)';
  }
}
...
abstract mixin class $TodoCopyWith<$Res> {
  factory $TodoCopyWith(Todo value, $Res Function(Todo) _then) =
      _$TodoCopyWithImpl;
  @useResult
  $Res call({String? objectId, String text, bool isDone});
}
...
class _Todo implements Todo {
  const _Todo({this.objectId, required this.text, required this.isDone});
